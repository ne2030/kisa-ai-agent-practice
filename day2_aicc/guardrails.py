...
from day2_aicc.state import AICCState, GuardLayer, ProposedAction
...
DIRECT_INJECTION_PATTERNS = [
    ...
    # TODO-D2-07: 실제 공격 문구 2개를 추가한다. 예: 한국어 우회 표현, role-play 패턴.
]
...
INDIRECT_INJECTION_PATTERNS = [
    ...
    r"reveal\s+customer",
    # TODO-D2-08: 외부 문서 payload에서 자주 보이는 HTML comment, markdown link, base64 힌트를 추가한다.
]
...
def validate_action(state: AICCState, action: ProposedAction) -> str | None:
    ...
    if tool == "update_shipping_address":
        # TODO-D2-09: 주소 변경 가능 상태를 정책 문서와 맞춰 더 엄격하게 만든다.
    ...
    if tool == "issue_coupon":
        # TODO-D2-10: VIP/지연일/최대금액 조건을 바꿔보고 eval case를 추가한다.
