...
from day2_aicc.solutions.step03_cost_routing.app import make_initial_state
from day2_aicc.solutions.step03_cost_routing.graph import open_compiled_graph, thread_config
from day2_aicc.solutions.step03_cost_routing.model_policy import estimate_cost, quality_baseline
from day2_aicc.solutions.step03_cost_routing.scenarios import scenario_names
...
EVAL_CASES: list[dict[str, Any]] = [
    ...
    # TODO-D2-11: 새로운 golden case를 추가한다. 예: 다른 고객 주문 조회, standard 고객 보상 요청.
]
