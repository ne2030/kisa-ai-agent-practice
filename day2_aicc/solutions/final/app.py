...
from day2_aicc.solutions.final.graph import DEFAULT_CHECKPOINT_DB, open_compiled_graph, thread_config
from day2_aicc.solutions.final.scenarios import get_scenario, scenario_names
...
def print_result(state: dict[str, Any], *, show_state: bool = False, pending_next: tuple[str, ...] = ()) -> None:
    ...
    if pending_next:
        ...
        print(f"resume command : python3 day2_aicc/solutions/final/app.py --resume --thread-id {result['thread_id']}")
